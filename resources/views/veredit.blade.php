                ...
                <div class="container-fluid">
                    ...
                    <center>
                        <div class="mb-4"
                            ...
                            <h2 class="h4 mb-2" style="font-weight: bold">Editar Usuario</h2>
                        </div>
                    </center>
                            ...
                            <div class="col-xl-6 col-lg-6 ">
                                ...
                                <form method="POST" action="{{ route('editar') }}">
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        color:black;" placeholder="Nombre" name="name" value="{{$vere->name}} "
                                            required>
                                    </div>
                                    <div class="md-form mb-2">
                                        <label for="apellido"><b>Apellidos</b></label>
                                        <input id="apellido" type="text" class="form-control" style="color:black;"
                                            placeholder="Apellidos" name="apellido" value="{{$vere->last_name}}"
                                            required>
                                    </div>
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <input id="email" type="email" class="form-control" style="color:black;"
                                            placeholder="E-mail" name="email" value="{{$vere->email}}"
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <input id="date" type="date" class="form-control" style="color:black;"
                                            name="date" value="{{$vere->date}}" required>
                                    </div>

                                    <div class="md-form mb-2">
                                        <label for="profesion"><b>Profesión</b></label>
                                        <input id="profesion" type="text" class="form-control" style="color:black;"
                                            placeholder="Profesión" name="profesion" value="{{$vere->profesion}}"
                                            required>
                                    </div>

                                    <div class="md-form mb-2">
                                        <label for="institucion"><b>Institución</b></label>
                                        <input id="institucion" type="text" class="form-control" style="color:black;"
                                            placeholder="Institución" name="institucion" value="{{$vere->institucion}}"
                                            required>
                                    </div>
                                    ...
                                    <a href="{{ route('usuarioListar') }}" class="btn btn-blue mt-2">
                                        Regresar
                                    </a>
                                    ...
                                    <a href="{{ route('eliminar',$vere->id)}}" class="btn btn-danger mt-2">
                                        Eliminar Usuario
                                    </a>
